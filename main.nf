...
params.download_sra   = true // Set to true to download from SRA instead of using local files
...
params.genome_url  = "${projectDir}/ref/Sus_scrofa.Sscrofa11.1.dna.toplevel.fa.gz"
params.gtf_url     = "${projectDir}/ref/Sus_scrofa.Sscrofa11.1.104.gtf.gz"
...
process DOWNLOAD_SRA {
    ...
    maxForks 10  // Limit concurrent downloads to avoid overwhelming NCBI servers
